...
public class StudentTestHashtableOpenAddressLinearProbing
{
   ...
   public void testWithHashSet()
   {
      ...
      HashtableOpenAddressLinearProbingImpl<HashtableElement> table3 = new HashtableOpenAddressLinearProbingImpl<HashtableElement>(SIZE, HashFunctionClosedAddressMethod.DIVISION);
